...
public class TMotorCommandTest
{
   ...
   private void testPackAndUnpack(TMotorParameters motorParameters)
   {
      ...
      for (int i = 0; i < 10000; i++)
      {
         ...
         double desiredVelocityFromCommand = CANTools.uint_to_double(rawDesiredVelocityFromCommand, velocityLimitLower, velocityLimitUpper, TMotorCommand.BITS_VELOCITY);
         ...
         double desiredCurrentFromCommand = CANTools.uint_to_double(rawDesiredCurrentFromCommand, torqueLimitLower, torqueLimitUpper, TMotorCommand.BITS_TORQUE);
