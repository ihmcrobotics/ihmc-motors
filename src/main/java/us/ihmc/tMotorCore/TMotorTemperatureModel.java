...
public class TMotorTemperatureModel extends TemperatureModel
{
   ...
   public TMotorTemperatureModel(String prefix, TMotorParameters parameters, CurrentProvider currentProvider, YoRegistry parentRegistry)
   {
      ...
      this.currentHeatProvider = new CurrentHeatProvider(prefix,
                                                         this.coilHeatItem,
                                                         currentProvider,
                                                         parameters.getCurrentAlpha(),
                                                         parameters.getElectricalResistance(),
                                                         parameters.getAmbientResistorTemperature(),
                                                         registry);
