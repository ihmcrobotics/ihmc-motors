...
public class PCANBasic
{
    ...
    */
   public native TPCANStatus Initialize(TPCANHandle Channel, TPCANBaudrate Btr0Btr1, TPCANType HwType, int IOPort, short Interrupt);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus InitializeFD(TPCANHandle Channel, TPCANBitrateFD BitrateFD);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus Read(TPCANHandle Channel, TPCANMsg MessageBuffer, TPCANTimestamp TimestampBuffer);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus ReadFD(TPCANHandle Channel, TPCANMsgFD MessageBuffer, TPCANTimestampFD TimestampBuffer);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus Write(TPCANHandle Channel, TPCANMsg MessageBuffer);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus WriteFD(TPCANHandle Channel, TPCANMsgFD MessageBuffer);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus FilterMessages(TPCANHandle Channel, int FromID, int ToID, TPCANMode Mode);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus GetValue(TPCANHandle Channel, TPCANParameter Parameter, Object Buffer, int BufferLength);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus SetValue(TPCANHandle Channel, TPCANParameter Parameter, Object Buffer, int BufferLength);
    ...
    * @return A TPCANStatus error code
    */
   public native TPCANStatus GetErrorText(TPCANStatus Error, short Language, StringBuffer Buffer);
