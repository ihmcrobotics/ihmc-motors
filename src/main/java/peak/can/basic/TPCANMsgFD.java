...
public class TPCANMsgFD implements Cloneable
{
   ...
   public void setType(byte type)
   {
      ...
      if (eset.contains(TPCANMessageType.PCAN_MESSAGE_EXTENDED) || eset.contains(TPCANMessageType.PCAN_MESSAGE_STATUS)
          || eset.contains(TPCANMessageType.PCAN_MESSAGE_RTR) || eset.contains(TPCANMessageType.PCAN_MESSAGE_BRS)
